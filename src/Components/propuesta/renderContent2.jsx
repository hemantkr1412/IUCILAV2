      ...
      case 1:
        return (
          <div className="formbox-text">
            <p>
              Te capacitarás en tasaciones y valuaciones de inmuebles, con
              conocimientos de metodologías de valoración arquitectónica,
              fiscal, legal, ambiental y cultural entre otras.
            </p>
            <p>
            ...
            <div className="formbox-text-inner">
              <div className="fti1">
                <div className="fti1-text">
                  ...
                  <div>
                    ...
                    <ul>
                      <li>
                        Diplomatura Universitaria en Tasación de Inmuebles (8
                        meses)
                      </li>
                    </ul>
                  </div>
              ...
              <div className="fti2">
                <Link
                  to="https://drive.google.com/file/d/1EyP3Hs8AQrDVhUaY_3iSWPzH4ckqnwj8/view?usp=drive_link  "
                  target="_blank"
                >
          ...
          <div className="formbox-content">
            ...
            <div className="form">
              <iframe
                ...
                height={300}
                style={{border:"none"}}
                src="https://inscripciones.ugd.edu.ar/simplified_contact_cases/new?theme=iucila&account=001Hp00002dZGl4IAG&office=a0aHp00000AH7RiIAL"
              />
            </div>
          </div>
        </div>
